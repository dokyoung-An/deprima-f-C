...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me.__18.logicBlock_position = function() {
			...
			if (me.__18.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__18.style.transition='right 0s, top 0s, transform 0s';
				if (me.__18.ggCurrentLogicStatePosition == 0) {
					me.__18.style.right='2px';
					me.__18.style.top = 'calc(50% - (380px / 2) + (0px / 2) + 5px)';
				}
				else {
					me.__18.style.right='15px';
					me.__18.style.top='calc(50% - ((380px + 0px) / 2) + 0px)';
				}
			}
		}
		...
		me.__48.appendChild(me._timer_1);
		me.__21.appendChild(me.__48);
		...
		me.__43.ggIsActive=function() {
			return (me.__43.ggTimestamp==0 ? false : (Math.floor((skin.ggCurrentTime - me.__43.ggTimestamp) / me.__43.ggTimeout) % 2 == 0));
		}
		el.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
		...
		me.__39.onmouseover=function (e) {
			me.elementMouseOver['_39']=true;
		}
		me.__39.onmousemove=function (e) {
		...
		me.__39.onmouseout=function (e) {
			me.elementMouseOver['_39']=false;
		}
		me.__39.ggCurrentLogicStateVisible = -1;
		me.__39.ggUpdateConditionTimer=function () {
			if (me.elementMouseOver['_39']) {
				me.__40.style.transition='none';
				me.__40.style.visibility=(Number(me.__40.style.opacity)>0||!me.__40.style.opacity)?'inherit':'hidden';
				me.__40.ggVisible=true;
			}
		...
		me.__38.ggIsActive=function() {
			return (me.__38.ggTimestamp==0 ? false : (Math.floor((skin.ggCurrentTime - me.__38.ggTimestamp) / me.__38.ggTimeout) % 2 == 0));
		}
		el.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
		...
		me.__34.onmousemove=function (e) {
		...
		me.__33.ggIsActive=function() {
			return (me.__33.ggTimestamp==0 ? false : (Math.floor((skin.ggCurrentTime - me.__33.ggTimestamp) / me.__33.ggTimeout) % 2 == 0));
		}
		el.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
 ...
 let url = '';
  ...
  document.body.removeChild(textarea);
		...
		me._rectangle_2.appendChild(me.__21);
		...
		me.__20.logicBlock_position = function() {
			...
			if (me.__20.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__20.style.transition='left 500ms ease 500ms, top 500ms ease 500ms, opacity 500ms ease 0ms';
				if (me.__20.ggCurrentLogicStatePosition == 0) {
					me.__20.style.left='-10px';
					me.__20.style.top = 'calc(50% - (43px / 2))';
				}
				else if (me.__20.ggCurrentLogicStatePosition == 1) {
					me.__20.style.left='20px';
					me.__20.style.top = 'calc(50% - (43px / 2))';
				}
				else {
					me.__20.style.left='0px';
					me.__20.style.top='calc(50% - ((43px + 0px) / 2) + 0px)';
				}
			}
		}
		...
		me.__20.logicBlock_alpha = function() {
			...
			if (me.__20.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				else if (me.__20.ggCurrentLogicStateAlpha == 1) {
		...
		me.__20.appendChild(me._rectangle_3);
		...
		me.__9.logicBlock_position = function() {
			...
			if (me.__9.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__9.style.transition='left 0s, top 0s, width 0s, height 0s, transform 0s';
				if (me.__9.ggCurrentLogicStatePosition == 0) {
					me.__9.style.left='10px';
					me.__9.style.top='45px';
				}
				else {
					me.__9.style.left='15px';
					me.__9.style.top='80px';
				}
			}
		}
		...
		me.__9.logicBlock_size = function() {
			...
			if (me.__9.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__9.ggCurrentLogicStateSize == 0) {
					me.__9.style.width='110px';
					me.__9.style.height='100px';
					skin.updateSize(me.__9);
				}
				else if (me.__9.ggCurrentLogicStateSize == 1) {
					me.__9.style.width='160px';
					me.__9.style.height='150px';
					skin.updateSize(me.__9);
				}
				else {
					me.__9.style.width='200px';
					me.__9.style.height='200px';
					skin.updateSize(me.__9);
				}
			}
		}
		...
		me._rectangle_41.appendChild(me.__12);
		me.__10.appendChild(me._rectangle_41);
		...
		me.__10.appendChild(me._map_11);
		...
		me.__10.appendChild(me._map_21);
		...
		me.__6.logicBlock_position = function() {
			...
			if (me.__6.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__6.style.transition='left 500ms ease 0ms, bottom 500ms ease 0ms';
				if (me.__6.ggCurrentLogicStatePosition == 0) {
					me.__6.style.left='5px';
					me.__6.style.bottom='-120px';
				}
				else {
					me.__6.style.left='5px';
		...
		me.__8.logicBlock_scaling = function() {
			...
			if (me.__8.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me.__8.ggCurrentLogicStateScaling == 0) {
					me.__8.ggParameter.sx = 0.7;
					me.__8.ggParameter.sy = 0.7;
		...
		me._rectangle_4.appendChild(me.__5);
		me.__4.appendChild(me._rectangle_4);
		...
		me.__4.appendChild(me._image_2);
	...
	me.skinTimerEvent=function() {
		...
		if (me.__43.ggLastIsActive!=me.__43.ggIsActive()) {
			me.__43.ggLastIsActive=me.__43.ggIsActive();
			if (me.__43.ggLastIsActive) {
				me.__45.style.transition='none';
				me.__45.style.visibility='hidden';
				me.__45.ggVisible=false;
			} else {
		...
		if (me.__38.ggLastIsActive!=me.__38.ggIsActive()) {
			me.__38.ggLastIsActive=me.__38.ggIsActive();
			if (me.__38.ggLastIsActive) {
				me.__40.style.transition='none';
				me.__40.style.visibility='hidden';
				me.__40.ggVisible=false;
			} else {
